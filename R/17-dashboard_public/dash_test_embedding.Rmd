...
# m = mapview(st_bbox(scd))
# m@map = m@map %>% 
#   addWMSTiles(group = 'SCD',
#               "https://maps.eurac.edu/geoserver/ows?service=wms&version=1.3.0",
#               layers  = "geonode:scd_2041_2070_rcp85_noglacier_16bit_3035",
#               options = WMSTileOptions(format = "image/png", transparent = TRUE),
#               attribution = "") %>% mapview:::mapViewLayersControl(names = c("SCD"))
# m


#wms_euracmaps = "https://maps.eurac.edu/geoserver/ows?service=wms&version=1.3.0"
wms_euracmaps = "https://maps.eurac.edu/geoserver/ows?"
layer_name = "geonode:scd_2041_2070_rcp85_noglacier_16bit_3035"
layer_name = "geonode:2000-10-01_2019-09-30"
#wms_grb <- "https://geoservices.informatievlaanderen.be/raadpleegdiensten/GRB-basiskaart/wms"
leaflet() %>%
  setView(lng = 11.347, lat = 46.464, zoom = 15) %>%
  addWMSTiles(
    wms_euracmaps,
    layers = layer_name,
    options = WMSTileOptions(format = "image/png", transparent = TRUE)
...
<iframe
  style="border: none;" height="400" width="600"
  src="http://sdi.eurac.edu/slider/clirsnow_future_rcp26_2071_2100.html">
</iframe>
