...
```{r vb5}
valueBox("RCP 2.6 vs RCP 8.5 2041-2070", icon = "fa-clock", 
         href="http://sdi.eurac.edu/slider/clirsnow_future_rcp26_rcp85_2041_2070.html")
```
...
```{r vb6}
valueBox("RCP 2.6 vs RCP 8.5 2071-2100", icon = "fa-clock", 
         href="http://sdi.eurac.edu/slider/clirsnow_future_rcp26_rcp85_2071_2100.html")
```
