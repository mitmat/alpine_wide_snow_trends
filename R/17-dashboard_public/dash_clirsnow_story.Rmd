...
- Matiu, M. Bias corrected and downscaled snow cover fraction from EURO-CORDEX RCMs for the Greater Alpine Region. 
...
```{r vb1}
valueBox("RCP 2.6 2041-2070", icon = "fa-long-arrow-alt-right", href="http://sdi.eurac.edu/slider/cci_snow_test.html")
```
...
```{r vb2}
valueBox("RCP 2.6 2071-2100", icon = "fa-long-arrow-alt-right", href="http://sdi.eurac.edu/slider/cci_snow_test_iframe.html")
```
...
```{r vb3}
valueBox("RCP 8.5 2041-2070", icon = "fa-level-up-alt", href="http://sdi.eurac.edu/slider/cci_snow_test.html")
```
...
```{r vb4}
valueBox("RCP 8.5 2071-2100", icon = "fa-level-up-alt", href="http://sdi.eurac.edu/slider/cci_snow_test_iframe.html")
```
