...
gg_pc_elev <- dat_sinkr_plot %>% 
  ggplot(aes(Elevation, value_sc, colour = cluster_fct))+
  geom_point(size = 0.5)+
  # geom_smooth()+
...
ggsave(gg_pc_elev2,
       filename = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/fig/Figure A4.png",
       width = 8, height = 4)
...
ggsave(gg_pca2,
       filename = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/fig/Figure A5.png",
       width = 8, height = 4)
