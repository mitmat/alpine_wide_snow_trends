...
dat_meta_ts[, popup_html := paste0(
  ...
  '<a href="ts-season/', Name, '.png" target="_blank">Seasonal snow indices <i class="fa fa-external-link-alt"></i></a><br><br>',
  '<a href="ts-month/', Name, '.png" target="_blank">Monthly mean snow depth <i class="fa fa-external-link-alt"></i></a><br>'
)]
