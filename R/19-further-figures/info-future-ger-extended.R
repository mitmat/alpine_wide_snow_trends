...
gg <- dat_dp[elev %in% elev_plot] %>% 
  ...
  annotate("text", 150, 36+1, hjust = 0, vjust = 0.5, size = 3, 
           label = "Tag mit Schneebedeckung, Gegenwart (2001-2020)", colour = "#2171b5")+
...
ggsave(gg, filename = "fig/future-ger-03-full.png",
...
ggsave(gg, filename = "fig/future-ger-01-past.png",
       width = 6, height = 4, units = "in")
...
ggsave(gg, filename = "fig/future-ger-02-paris.png",
       width = 6, height = 4, units = "in")
