...
saveRDS(dat_plot_cluster, 
        "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/rds/meta-with-cluster-01.rds")

saveRDS(km_fit, 
        "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/rds/regions-03-km-obj.rds")
...
save(mat_eof_sub, pca_prcomp, pca_prcomp_summary,
     file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/rds/regions-02-pca-full.rda")
...
saveRDS(dat_plot_cluster, 
        "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/rds/meta-with-cluster-02-pca-full.rds")
