...
dat_plot_full <- dat_seasonal_sen[startsWith(variable, "SCD")] %>% 
...
ggsave(gg,
       filename = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/03_review2/fig/trends-seasonalSCD-sen.png",
       width = 10,
       height = 11)
...
read_docx() %>% 
  ...
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/03_review2/table/trends-sen-seasonalSCD-500m.docx")
...
read_docx() %>% 
  body_add_flextable(ft) %>% 
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/03_review2/table/trends-sen-seasonalSCD-1000m.docx")
