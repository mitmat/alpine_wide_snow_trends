...
read_docx() %>% 
  ...
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/SCD_ge_1cm/Table 3_absolute_SCD1cm.docx")
...
read_docx() %>% 
  body_add_flextable(ft) %>% 
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/SCD_ge_1cm/Table 3_relative_SCD1cm.docx")
