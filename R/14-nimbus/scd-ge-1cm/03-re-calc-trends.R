...
save(# dat_month_ols, dat_month_gls, 
     dat_seasonal_ols, dat_seasonal_gls,
     file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/SCD_ge_1cm/trends-01-1971-2019-ols-gls.rda")
