...
fns_all <- dir_ls("/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/SCD_ge_1cm/")

fns_all[grep("^SCD", path_file(fns_all))] %>% 
  lapply(function(x) {
    dat <- readRDS(x)
...
saveRDS(dat_ind_long2_full, "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/SCD_ge_1cm/data-02-seasonalSCD.rds")
